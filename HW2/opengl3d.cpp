...
void initialize_camera(void) {
	...
	ModelMatrix_COW_BODY_to_COW_EYE = glm::translate(glm::mat4(1.0f), glm::vec3(-3.0f, 0.5f, 0.0f));
	ModelMatrix_COW_BODY_to_COW_EYE = glm::rotate(ModelMatrix_COW_BODY_to_COW_EYE,
		TO_RADIAN*90.0f, glm::vec3(0.0f, 1.0f, 0.0f));
}
...
void renew_cam_position_z(int del) {
	camera_wv.pos += CAM_TSPEED*del*(-camera_wv.naxis);
}

void renew_cam_position_y(int del) {
	camera_wv.pos += CAM_TSPEED*del*(camera_wv.vaxis);
}

void renew_cam_position_x(int del) {
	camera_wv.pos += CAM_TSPEED*del*(-camera_wv.uaxis);
}

#define CAM_RSPEED 5.0f
...
void renew_cam_orientation_rotation_around_u_axis(int angle) {
	...
	RotationMatrix = glm::mat3(glm::rotate(glm::mat4(1.0), CAM_RSPEED*TO_RADIAN*angle, camera_wv.uaxis));
...
void renew_cam_orientation_rotation_around_n_axis(int angle) {
	...
	RotationMatrix = glm::mat3(glm::rotate(glm::mat4(1.0), CAM_RSPEED*TO_RADIAN*angle, camera_wv.naxis));
	camera_wv.uaxis = RotationMatrix*camera_wv.uaxis;
	camera_wv.vaxis = RotationMatrix*camera_wv.vaxis;
}

void renew_cam_orientation_rotation_around_cam_cow_u_axis(int angle) {
	ModelMatrix_COW_BODY_to_COW_EYE = glm::rotate(ModelMatrix_COW_BODY_to_COW_EYE,
		TO_RADIAN*angle, glm::vec3(1.0f, 0.0f, 0.0f));
}

void renew_cam_orientation_rotation_around_cam_cow_v_axis(int angle) {
	ModelMatrix_COW_BODY_to_COW_EYE = glm::rotate(ModelMatrix_COW_BODY_to_COW_EYE,
		TO_RADIAN*angle, glm::vec3(0.0f, 1.0f, 0.0f));
}

void renew_cam_orientation_rotation_around_cam_cow_n_axis(int angle) {
	ModelMatrix_COW_BODY_to_COW_EYE = glm::rotate(ModelMatrix_COW_BODY_to_COW_EYE,
		TO_RADIAN*angle, glm::vec3(0.0f, 0.0f, 1.0f));
}

void renew_cam_orientation_rotation_around_cam_driver_u_axis(int angle) {
	ModelMatrix_CAR_BODY_to_DRIVER = glm::rotate(ModelMatrix_CAR_BODY_to_DRIVER,
		TO_RADIAN*angle, glm::vec3(1.0f, 0.0f, 0.0f));
}

void renew_cam_orientation_rotation_around_cam_driver_v_axis(int angle) {
	ModelMatrix_CAR_BODY_to_DRIVER = glm::rotate(ModelMatrix_CAR_BODY_to_DRIVER,
		TO_RADIAN*angle, glm::vec3(0.0f, 1.0f, 0.0f));
}

void renew_cam_orientation_rotation_around_cam_driver_n_axis(int angle) {
	ModelMatrix_CAR_BODY_to_DRIVER = glm::rotate(ModelMatrix_CAR_BODY_to_DRIVER,
		TO_RADIAN*angle, glm::vec3(0.0f, 0.0f, 1.0f));
}
/*********************************  END: camera *********************************/
